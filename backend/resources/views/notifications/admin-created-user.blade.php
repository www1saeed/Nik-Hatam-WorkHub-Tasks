            ...
            <td style="padding:0 24px 24px; text-align:{{ $align }}; color:#111827; font-size:14px; line-height:1.7;">
                ...
                <div style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:8px; padding:12px; margin-bottom:16px;">
                    <div style="margin-bottom:6px;">
                        ...
                        <span style="margin-inline-start:8px;">{{ $usernameValue }}</span>
                    </div>
                    <div>
                        <strong>{{ $passwordLabel }}</strong>
                        <span style="margin-inline-start:8px;">{{ $passwordValue }}</span>
                    </div>
                </div>

                <div style="margin-bottom:16px;">{{ $passwordHint }}</div>
